...
if [[ ! -f $FIREDRAKE_INSTALLED ]]; then
    ...
    SLEPC4PY_INSTALL_SCRIPT_PATH=${SLEPC4PY_INSTALL_SCRIPT_PATH:-"https://github.com/angus-g/fem-on-colab/raw/refs/heads/angus-g/firedrake-mmg/slepc4py/install.sh"}
