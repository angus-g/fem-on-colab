...
if [[ ! -f $SLEPC4PY_INSTALLED ]]; then
    ...
    PETSC4PY_INSTALL_SCRIPT_PATH=${PETSC4PY_INSTALL_SCRIPT_PATH:-"https://github.com/angus-g/fem-on-colab/raw/refs/heads/angus-g/firedrake-mmg/petsc4py/install.sh"}
